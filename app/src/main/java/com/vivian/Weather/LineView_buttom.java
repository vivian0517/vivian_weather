...
public class LineView_buttom extends View {
    ...
    public LineView_buttom(Context context) {
        super(context);
        init();
    }

    public LineView_buttom(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public LineView_buttom(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void drawValue(Canvas canvas) {
        ...
        Paint.FontMetrics fontMetrics = mPaint.getFontMetrics();
        //取字体高度的三分之一
        canvas.drawText(currentValue + "°", viewWidth / 2, pointY + (fontMetrics.descent + Math.abs(fontMetrics.ascent)) , mPaint);
    }
